...
if(isset($_POST["submit"]))
{
    ...
    $tax=$_POST['tax'];
    $dupsql="SELECT * from `desig` WHERE `dname`='$dname' ";
    $duplicate=mysqli_query($conn,$dupsql);
    if(mysqli_num_rows($duplicate)>0)
    {
      echo "<script>
      alert('Data is already submitted');
      location.replace('add_desig.php?');
      </script>";
    }


    else{
      $sql="INSERT INTO `desig`(`dname`, `lrange`, `urange`, `Basic_salary`, `tax`) VALUES ('$dname','$lrange','$urange','$Basic_salary','$tax')";
    ...
    <div id="wrapper">
        <div class="d-flex flex-column" id="content-wrapper" style="height: 100%;">
                ...
                <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse text-center" id="navcol-1">
                        <ul class="nav navbar-nav text-center mx-auto" style="margin: 0px;margin-left: 0px;width:100%;padding: 0px;padding-right: 0px;padding-left: 0px;">
                            ...
                            <li class="nav-item" role="presentation" style="margin-right: 15px;"><a class="nav-link active" href="add_desig.php">Add Designation</a></li>
            ...
            <div class="login-dark" style="background-image: url(&quot;assets/img/laptop2.jpg&quot;);height: 860px;">
                <form class="text-center" method="post" style="background-color: rgba(255,255,255,0.78);padding-top: 20px;padding-bottom: 20px;padding-right: 30px;padding-left: 30px;margin-top: 0px;"><label class="text-left" style="color: rgb(90,92,105);font-size: 20px;font-weight: normal;margin-top: 0px;">Add Designation</label>
                    <div class="illustration" style="padding-top: 0px;padding-bottom: 25px;margin-top: -20px;margin-bottom: -20px;"><i class="fas fa-users" style="color: rgba(55,55,55,0.77);margin-top: 0px;"></i></div>
                    <div class="form-group"><label style="color: rgb(90,92,105);">Designation Name</label><input class="form-control" type="text" name="dname" placeholder="Enter Designation" required="" style="color: rgb(90,92,105);"></div>
                    <div class="form-group"><label style="color: rgb(90,92,105);">Lower Range</label><input class="form-control" type="number" style="color: rgb(90,92,105);" placeholder="Enter Lower Range" name="lrange" required=""></div>
                    <div class="form-group"><label style="color: rgb(90,92,105);">Upper Range</label><input class="form-control" type="number" style="color: rgb(90,92,105);" placeholder="Enter Upper Range" name="urange" required=""></div>
                    <div class="form-group"><label style="color: rgb(90,92,105);">Basic Salary</label><input class="form-control" type="number" style="color: rgb(90,92,105);" placeholder="Enter Basic Salary" name="Basic_salary" required=""></div>
                    <div class="form-group"><label style="color: rgb(90,92,105);">Tax (%)</label><input class="form-control" type="number" style="color: rgb(90,92,105);" placeholder="Enter Tax Rate" name="tax" required=""></div>
                    <div class="form-group"><button class="btn btn-primary btn-block" type="submit" name="submit" style="background-color: rgb(55,55,55);">Add Designation</button></div>
                </form>
            </div>
