...
if(isset($_POST["submit"]))
{
	...
	$dupsql="SELECT * from `fixed_bonus` WHERE `month`='$month' AND `year`='$year' ";
    $duplicate=mysqli_query($conn,$dupsql);
    if(mysqli_num_rows($duplicate)>0)
    {
      echo "<script>
      alert('Data is already submitted');
      location.replace('fix_bonus.php?');
      </script>";
    }
	else
	{
	
	$sql="INSERT INTO `fixed_bonus`(`month` ,`year` ,`rate`) VALUES ('$month','$year','$rate')";
    ...
    <div id="wrapper">
        <div class="d-flex flex-column" id="content-wrapper" style="height: 100%;">
                    ...
                    <div class="collapse navbar-collapse text-center" id="navcol-1">
                        <ul class="nav navbar-nav text-center mx-auto" style="margin: 0px;margin-left: 0px;width:100%;padding: 0px;padding-right: 0px;padding-left: 0px;">
                            ...
                            <li class="nav-item dropdown" style="margin-right: 15px;"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="normal_bonus.php">Set Bonus</a>
                                <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="normal_bonus.php">Normal Bonus</a><a class="dropdown-item active" role="presentation" href="fix_bonus.php">Occasional Bonus</a></div>
                            </li>
            ...
            <div class="login-dark" style="background-image: url(&quot;assets/img/laptop2.jpg&quot;);height: 860px;">
                <form class="text-center" method="post" style="background-color: rgba(255,255,255,0.78);padding-top: 20px;padding-bottom: 20px;padding-right: 30px;padding-left: 30px;margin-top: -64px;"><label class="text-left" style="color: rgb(90,92,105);font-size: 20px;font-weight: normal;margin-top: 0px;">Set Occasional Bonus</label>
