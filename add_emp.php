...
if(isset($_POST["submit"]))
{
    ...
    $dupsql="SELECT * from `emp` WHERE `fname`='$fname' AND `email`='$email' ";
    $duplicate=mysqli_query($conn,$dupsql);
    if(mysqli_num_rows($duplicate)>0)
    {
      echo "<script>
      alert('Data is already submitted');
      location.replace('add_emp.php?');
      </script>";
    }
    else{
      $sql="INSERT INTO `emp`(`fname`, `add`, `gender`, `email`, `cont`, `dob`, `doj`, `desig`, `pass`) VALUES ('$fname','$add','$gender','$email','$cont','$dob','$doj','$desig','$pass')";
  ...
  else
  {
    if($num_rows==0)
    {
        $rsql="ALTER `emp` AUTO_INCREMENT=1";
        $rrec=mysqli_query($conn,$rsql);
    }
  }
    ...
    <div id="wrapper">
        <div class="d-flex flex-column" id="content-wrapper" style="height: 100%;">
                    ...
                    <div class="collapse navbar-collapse text-center" id="navcol-1">
                        <ul class="nav navbar-nav text-center mx-auto" style="margin: 0px;margin-left: 0px;width:100%;padding: 0px;padding-right: 0px;padding-left: 0px;">
                            ...
                            <li class="nav-item dropdown" style="margin-right: 15px;"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Employee</a>
                                <div class="dropdown-menu" role="menu"><a class="dropdown-item active" role="presentation" href="add_emp.php">Add Employee</a><a class="dropdown-item" role="presentation" href="emp_details.php">Employee Details</a></div>
                            </li>
            ...
            <div class="login-dark" style="background-image: url(&quot;assets/img/laptop2.jpg&quot;);height: 1252px;">
                <form class="text-center" method="post" style="background-color: rgba(255,255,255,0.78);padding-top: 20px;padding-bottom: 20px;padding-right: 30px;padding-left: 30px;"><label class="text-left" style="color: rgb(90,92,105);font-size: 20px;font-weight: normal;margin-top: 0px;">Add Employee</label>
                    ...
                    <div class="form-group"><label style="color: rgb(90,92,105);">Full Name</label><input class="form-control" type="text" name="fname" placeholder="Enter Full Name" required="" style="color: rgb(90,92,105);"></div>
                    <div class="form-group"><label style="color: rgb(90,92,105);">Address</label><input class="form-control" type="text" name="add" placeholder="Enter Address" required="" style="color: rgb(90,92,105);"></div>
                    ...
                    <div
                        class="form-group"><label style="color: rgb(90,92,105);">E-mail</label><input class="form-control" type="text" name="email" placeholder="Enter E-mail" required="" style="color: rgb(90,92,105);"></div>
            <div class="form-group"><label style="color: rgb(90,92,105);">Contact No.</label><input class="form-control" type="text" name="cont" placeholder="Enter Contact No." required="" style="color: rgb(90,92,105);" maxlength="10" size="10" onKeyPress="allowNumbersOnly(event)" ></div>
            <div class="form-group"><label style="color: rgb(90,92,105);">Date Of Birth</label><input class="form-control" type="date" name="dob" style="color: rgb(90,92,105);" required=""></div>
            <div class="form-group"><label style="color: rgb(90,92,105);">Date Of Joining</label><input class="form-control" type="date" name="doj" style="color: rgb(90,92,105);" required=""></div>
            <div class="form-group"><label style="color: rgb(90,92,105);">Designation</label><select class="custom-select" style="color: rgb(90,92,105);" required="" name="desig"><option  disabled value = "" selected>~ Select Designation ~</option><?php
                  ...
                  ?></select></div>
            <div class="form-group"><label style="color: rgb(90,92,105);">Password</label><input class="form-control" type="password" name="pass" placeholder="Enter Password" style="color: rgb(90,92,105);" required=""></div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" name="submit" style="background-color: rgb(55,55,55);">Add Employee</button></div>
            </form>
        </div>
