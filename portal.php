...
<body id="page-top" style="height: 100%;">
    ...
    <div class="login-dark" style="background-image: url(&quot;assets/img/laptop2.jpg&quot;);background-repeat: no-repeat;background-size: cover;background-position: center;height: 911px;">
        <div class="text-right" style="padding-top: 15px;margin-top: 0px;height: 98px;"><button class="btn btn-dark invisible" type="button" style="margin-right: 20px;"><i class="fa fa-arrow-circle-left" style="margin-right: 5px;"></i>Go Back</button></div>
        <h1 class="text-center" style="padding-top: 35px;padding-bottom: 0px;color: rgb(255,255,255);font-size: 48px;font-weight: bold;line-height: 36px;font-style: normal;font-family: 'Abril Fatface', cursive;margin-bottom: 8px;margin-top: -51px;">Welcome</h1>
        <form class="text-center" method="post" style="background-color: rgba(255,255,255,0.78);padding-top: 20px;padding-bottom: 20px;padding-right: 30px;width: 300px;padding-left: 30px;margin-top: -110px;"><label class="text-left" style="color: rgb(90,92,105);font-size: 20px;font-weight: normal;margin-top: 0px;">Portal</label>
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="button" style="background-color: rgb(55,55,55);" onClick="location.href='admin_login.php'"><i class="fas fa-user-shield" style="font-size: 18px;margin-right: 6px;"></i>Admin Portal</button></div>
            <div class="form-group"><button class="btn btn-primary btn-block" type="button" style="background-color: rgb(55,55,55);" onClick="location.href='user_login.php'"><i class="fas fa-user" style="font-size: 18px;margin-right: 6px;"></i>User Portal</button></div>
        </form>
    </div>
