...
<body id="page-top" style="height: 100%;padding: 0px;">
        ...
        <div class="d-flex flex-column" id="content-wrapper" style="height: 100%;">
                    ...
                    <div class="collapse navbar-collapse text-center" id="navcol-1">
                        <ul class="nav navbar-nav text-center mx-auto" style="margin: 0px;margin-left: 0px;width:100%;padding: 0px;padding-right: 0px;padding-left: 0px;">
                            ...
                            <li class="nav-item dropdown" style="margin-right: 15px;"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Attendance</a>
                                <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="user_attendence.php">Attendance Form</a><a class="dropdown-item active" role="presentation" href="attendence_record.php">Attendance Details</a></div>
                            </li>
            ...
            <div class="card shadow" style="margin-right: 12px;margin-left: 12px;margin-bottom: 447px;margin-top: 90px;">
                <div class="card-header py-3" style="height: 68px;">
                    <p class="lead text-center text-primary m-0 font-weight-bold">Attendance Details</p>
                </div>
    ...
    <input type="text" class="search form-control" placeholder="What you looking for?">
                    ...
                    <form method="get"><div><label style="margin-right: 4px;">Date<select class="custom-select custom-select-sm" style="width: 110px;margin-left: 6px;margin-right: 8px;" required="" name="date"><option  disabled value = "" selected>~ Select ~</option><?php
                  ...
                  ?></select></label><label style="margin-right: 4px;">Month<select class="custom-select custom-select-sm" style="width: 110px;margin-right: 8px;margin-left: 6px;" required="" name="month"><option  disabled value = "" selected>~ Select ~</option><?php
...
<table class="table table-striped table-bordered results table-sm">
      ...
      <td colspan="14"><font size="+4"><i class="fa fa-warning"></i> No result found</font></td>
		  ...
		  $sear="SELECT * FROM `attendence_form` WHERE `date`='$date' AND `month`='$month' AND `year`='$year'";
          $al="ALTER TABLE `emp` ORDER BY `id`";
          ...
          if($numrows>0)
          {
			...
			while($sfres = mysqli_fetch_assoc($result))
            {
              ...
              ?>
                                <tr class="text-center">
                                    <td><?php echo $sfres['id'];?></td>
                                    <td><?php echo $sfres['empid'];?></td>
                                    <td><?php echo $sfres['timein'];?></td>
                                    <td><?php echo $sfres['timeout'];?></td>
                                    <td><?php echo $sfres['date'];?></td>
                                    <td><?php echo $sfres['month'];?></td>
                                    <td><?php echo $sfres['year'];?></td>
                                    <td><?php echo $sfres['present'];?></td>
                                </tr>
							<?php
            }
          }
