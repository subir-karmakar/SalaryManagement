...
if(isset($_POST["submit"]))
{
	...
	$dupsql="SELECT * FROM `deduction`";
    $duplicate=mysqli_query($conn,$dupsql);
    if(mysqli_num_rows($duplicate)>0)
    {
      $rsql="UPDATE `deduction` SET `pf`='$pf' WHERE `deduc_id`='1'";
      $rrec=mysqli_query($conn,$rsql);
    }
	else
	{
	
	$sql="INSERT INTO `deduction`(`pf`) VALUES ('$pf')";
    ...
    if($query)
    {
        print '';
		echo "<script>
				location.replace('set_deduc.php?');
		</script>";
    ...
    <div id="wrapper">
        <div class="d-flex flex-column" id="content-wrapper" style="height: 100%;">
                ...
                <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse text-center" id="navcol-1">
                        <ul class="nav navbar-nav text-center mx-auto" style="margin: 0px;margin-left: 0px;width:100%;padding: 0px;padding-right: 0px;padding-left: 0px;">
                            ...
                            <li class="nav-item" role="presentation" style="margin-right: 15px;"><a class="nav-link active" href="set_deduc.php">Set Deductions</a></li>
            ...
            <div class="login-dark" style="background-image: url(&quot;assets/img/laptop2.jpg&quot;);height: 860px;">
                <form class="text-center" method="post" style="background-color: rgba(255,255,255,0.78);padding-top: 20px;padding-bottom: 20px;padding-right: 30px;padding-left: 30px;margin-top: -102px;"><label class="text-left" style="color: rgb(90,92,105);font-size: 20px;font-weight: normal;margin-top: 0px;">Set Deductions</label>
                    ...
                    <div class="form-group"><label style="color: rgb(90,92,105);">PF (%)</label><input class="form-control" type="number" style="color: rgb(90,92,105);" placeholder="Enter PF" name="pf" required=""></div>
                    <div class="form-group"><button class="btn btn-primary btn-block" type="submit" name="submit" style="background-color: rgb(55,55,55);">Set Deduction</button></div>
                </form>
            </div>
